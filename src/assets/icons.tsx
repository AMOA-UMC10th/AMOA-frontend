...
export function Notifications({ className }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M183 88 V72 C183 53 198 38 218 38 C237 38 253 53 253 72 V88 Z"
        fill="#191D1D"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M80 220 C80 157 124 103 183 88 C194 85 206 83 218 83 C230 83 242 85 253 88 C313 103 357 157 357 220 V384 H403 V431 H34 V384 H80 Z M126 220 V384 H310 V220 C310 170 269 130 218 130 C167 130 126 170 126 220 Z"
        fill="#191D1D"
      />
      <path
        d="M172 453 H264 C264 479 244 499 218 499 C192 499 172 479 172 453 Z"
        fill="#191D1D"
      />
    </svg>
  );
